...
export const MessageReceiveEvent = z.object({
  event_type: z.literal('message_receive'),
  time: z.number().int().nonnegative().describe('事件 Unix 时间戳（秒）'),
  self_id: zUin.describe('机器人 QQ 号'),
  data: z.lazy(() => IncomingMessage).describe('消息接收事件'),
}).describe('消息接收事件');
export type MessageReceiveEvent = z.infer<typeof MessageReceiveEvent>;
...
export const GroupDisbandEvent = z.object({
...
export type GroupDisbandEvent = z.infer<typeof GroupDisbandEvent>;
...
export const IncomingTextSegment = z.object({
  type: z.literal('text'),
  data: z.object({
    text: z.string().describe('文本内容'),
  }),
}).describe('文本消息段');
export type IncomingTextSegment = z.infer<typeof IncomingTextSegment>;

export const IncomingMentionSegment = z.object({
...
export type IncomingMentionSegment = z.infer<typeof IncomingMentionSegment>;

export const IncomingMentionAllSegment = z.object({
  type: z.literal('mention_all'),
  data: z.object({
  }),
}).describe('提及全体消息段');
export type IncomingMentionAllSegment = z.infer<typeof IncomingMentionAllSegment>;

export const IncomingFaceSegment = z.object({
  type: z.literal('face'),
  data: z.object({
    face_id: z.string().describe('表情 ID'),
...
export type IncomingFaceSegment = z.infer<typeof IncomingFaceSegment>;

export const IncomingReplySegment = z.object({
...
export type IncomingReplySegment = z.infer<typeof IncomingReplySegment>;

export const IncomingImageSegment = z.object({
...
export type IncomingImageSegment = z.infer<typeof IncomingImageSegment>;

export const IncomingRecordSegment = z.object({
...
export type IncomingRecordSegment = z.infer<typeof IncomingRecordSegment>;

export const IncomingVideoSegment = z.object({
...
export type IncomingVideoSegment = z.infer<typeof IncomingVideoSegment>;

export const IncomingFileSegment = z.object({
  type: z.literal('file'),
  data: z.object({
    file_id: z.string().describe('文件 ID'),
    file_name: z.string().describe('文件名称'),
...
export type IncomingFileSegment = z.infer<typeof IncomingFileSegment>;

export const IncomingForwardSegment = z.object({
...
export type IncomingForwardSegment = z.infer<typeof IncomingForwardSegment>;

export const IncomingMarketFaceSegment = z.object({
...
export type IncomingMarketFaceSegment = z.infer<typeof IncomingMarketFaceSegment>;

export const IncomingLightAppSegment = z.object({
...
export type IncomingLightAppSegment = z.infer<typeof IncomingLightAppSegment>;

export const IncomingXmlSegment = z.object({
  type: z.literal('xml'),
  data: z.object({
...
export type IncomingXmlSegment = z.infer<typeof IncomingXmlSegment>;

export const IncomingMarkdownSegment = z.object({
  type: z.literal('markdown'),
  data: z.object({
    content: z.string().describe('Markdown 内容'),
  }),
}).describe('Markdown 消息段');
export type IncomingMarkdownSegment = z.infer<typeof IncomingMarkdownSegment>;
...
export const OutgoingTextSegment = z.object({
  type: z.literal('text'),
  data: z.object({
    text: z.string().describe('文本内容'),
  }),
}).describe('文本消息段');
export type OutgoingTextSegment = z.infer<typeof OutgoingTextSegment>;

export const OutgoingMentionSegment = z.object({
  type: z.literal('mention'),
  data: z.object({
    user_id: zUin.describe('提及的 QQ 号'),
  }),
}).describe('提及消息段');
export type OutgoingMentionSegment = z.infer<typeof OutgoingMentionSegment>;

export const OutgoingMentionAllSegment = z.object({
  type: z.literal('mention_all'),
  data: z.object({
  }),
}).describe('提及全体消息段');
export type OutgoingMentionAllSegment = z.infer<typeof OutgoingMentionAllSegment>;

export const OutgoingFaceSegment = z.object({
  type: z.literal('face'),
  data: z.object({
    face_id: z.string().describe('表情 ID'),
...
export type OutgoingFaceSegment = z.infer<typeof OutgoingFaceSegment>;

export const OutgoingReplySegment = z.object({
  type: z.literal('reply'),
  data: z.object({
    message_seq: z.number().int().nonnegative().describe('被引用的消息序列号'),
  }),
}).describe('回复消息段');
export type OutgoingReplySegment = z.infer<typeof OutgoingReplySegment>;

export const OutgoingImageSegment = z.object({
  type: z.literal('image'),
  data: z.object({
...
export type OutgoingImageSegment = z.infer<typeof OutgoingImageSegment>;

export const OutgoingRecordSegment = z.object({
  type: z.literal('record'),
  data: z.object({
    uri: z.string().describe('文件 URI，支持 `file://` `http(s)://` `base64://` 三种格式'),
  }),
}).describe('语音消息段');
export type OutgoingRecordSegment = z.infer<typeof OutgoingRecordSegment>;

export const OutgoingVideoSegment = z.object({
  type: z.literal('video'),
  data: z.object({
    uri: z.string().describe('文件 URI，支持 `file://` `http(s)://` `base64://` 三种格式'),
...
export type OutgoingVideoSegment = z.infer<typeof OutgoingVideoSegment>;

export const OutgoingForwardSegment = z.object({
  type: z.literal('forward'),
  data: z.object({
...
export type OutgoingForwardSegment = z.infer<typeof OutgoingForwardSegment>;

export const OutgoingLightAppSegment = z.object({
  type: z.literal('light_app'),
  data: z.object({
    json_payload: z.string().describe('小程序 JSON 数据'),
  }),
}).describe('小程序消息段');
export type OutgoingLightAppSegment = z.infer<typeof OutgoingLightAppSegment>;
