...
import { AccordionContent, AccordionHeader, AccordionItem, AccordionTrigger, Accordion as Root } from './ui/accordion';
import { buttonVariants } from './ui/button';

export function Accordions({ type = 'single', ref, className, defaultValue, ...props }: ComponentProps<typeof Root>) {
